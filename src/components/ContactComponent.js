...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3) 
            errors.firstname = "Fisrt Name should be great than or equal to three (3)";
        else if(this.state.touched.firstname && firstname.length > 10)
        errors.firstname = "Fisrt Name should be less than or equal to ten (10)";

        if(this.state.touched.lastname && lastname.length < 3) 
            errors.lastname = "Last Name should be great than or equal to three (3)";
        else if(this.state.touched.lastname && lastname.length > 10)
        errors.lastname = "Last Name should be less than or equal to ten (10)";
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input tel="text" id="telnum" name="telnum" placeholder="Telephone Number" value={this.state.telnum} onChange={this.handleInputChange} onBlur={this.handleBlur('telnum')} valid={errors.telnum == ''} invalid={errors.telnum !== ''}  />
                                ...
                                <Col md={{size: 6, offset:2}}>
                                    <FormGroup check>
                                        <Label check>
                                            ...
                                            <strong>May we contact you you</strong>
                                        </Label>
                                    </FormGroup>
                                </Col>
